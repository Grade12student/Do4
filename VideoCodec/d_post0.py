...
def decoder(loadmodel, refer_path, outputfolder):
    ...
    with tf.compat.v1.Session(graph=graph) as sess:
        ...
        # Load the measurement matrix from the encoder
        with open(outputfolder + 'measurement_matrix.pkl', 'rb') as f:
            measurement_matrix = pickle.load(f)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--refer_frame', type=str, dest="refer_path", default='./frames', help="refer frame folder")
